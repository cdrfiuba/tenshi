...
// Debería ser (N * 2 * CANTIDAD_DE_INTERRUPCIONES_EMISORES_SUPERIORES), de 
// manera que sea un número entero de ciclos completos de la interrupcion. 
// Con 23 interrupciones, y N = 4, son 184 interrupciones.
#define CANTIDAD_DE_INTERRUPCIONES_EMISORES_RECEPTORES          184 
